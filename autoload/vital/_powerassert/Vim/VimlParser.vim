...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_powerassert#Vim#VimlParser#import() abort
    return map({'isalnum': '', 'isalpha': '', 'ExArg': '', 'islower': '', 'isnamec': '', 'iswordc1': '', 'iswhite': '', 'isdigit': '', 'import': '', 'isvarname': '', 'Node': '', 'Err': '', 'isnamec1': '', 'isargname': '', 'isupper': '', 'isxdigit': '', 'iswordc': '', 'isodigit': '', 'isidc': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_powerassert#Vim#VimlParser#import() abort', printf("return map({'isalnum': '', 'isalpha': '', 'ExArg': '', 'islower': '', 'isnamec': '', 'iswordc1': '', 'iswhite': '', 'isdigit': '', 'import': '', 'isvarname': '', 'Node': '', 'Err': '', 'isnamec1': '', 'isargname': '', 'isupper': '', 'isxdigit': '', 'iswordc': '', 'isodigit': '', 'isidc': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
